    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <JourneyCard
          step={1}
          title="Discover"
          description="Find trusted AI agents"
          href="/marketplace"
          icon={Sparkles}
          color="green"
        />
        <JourneyCard
          step={2}
          title="Create"
          description="Build & train your agents"
          href="/agents/new"
          icon={Bot}
          color="blue"
        />
        <JourneyCard
          step={3}
          title="Govern"
          description="Oversight & verification"
          href="/council"
          icon={Scale}
          color="purple"
        />
        <JourneyCard
          step={4}
          title="Grow"
          description="Track earnings & usage"
          href="/earnings"
          icon={TrendingUp}
          color="yellow"
        />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard
          ...
          subtitle={`${stats?.agents_published || 0} published`}
          icon={Bot}
          color="blue"
          href="/agents"
        />
        <StatCard
          title="Acquired"
          value={stats?.acquired_agents?.toString() || '0'}
          subtitle={`${stats?.active_acquisitions || 0} active`}
          icon={ShoppingCart}
          color="green"
          href="/portfolio"
        />
        ...
        <StatCard
          title="This Month"
          value={`$${(stats?.this_month_earnings || 0).toFixed(0)}`}
          subtitle={stats?.pending_escalations ? `${stats.pending_escalations} pending` : 'No issues'}
          icon={DollarSign}
          color="yellow"
