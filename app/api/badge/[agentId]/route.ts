...
function generateFullBadge(
  ...
  <g transform="translate(12, 96)">
    <text font-family="Inter, system-ui, sans-serif" font-size="8" fill="${subTextColor}">Verify at agentanchorai.com</text>
  </g>
</svg>`
}
...
export async function GET(
  ...
  try {
    ...
    const verifyUrl = `https://agentanchorai.com/verify/agent/${agentId}`
    let svg: string
